...
class RegimeHistoryQueryParams(FredSeriesQueryParams):
    start_date: Optional[date_type] = None
    end_date: Optional[date_type] = None


class RegimeHistoryData(FredSeriesData):
    date: str = Field(description="날짜 (YYYY-MM-DD)")
    regime: str = Field(description="레짐 (goldilocks/reflation/stagflation/deflation)")
    growth_score: Optional[float] = Field(default=None, description="성장 점수")
    inflation_score: Optional[float] = Field(default=None, description="인플레이션 점수")
    gdp_growth: Optional[float] = Field(default=None, description="실질 GDP 성장률 (%)")
    cpi_yoy: Optional[float] = Field(default=None, description="CPI YoY (%)")
