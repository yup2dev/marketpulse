...
class SecBaseFiling(BaseData):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, url: str, use_cache: bool = True):
        ...
        from data_fetcher.utils.provider_helpers import run_async
    ...
    async def _adownload_file(url, use_cache: bool = True):
        ...
        from data_fetcher.providers.sec.utils.definitions import SEC_HEADERS
        from data_fetcher.providers.sec.utils.helpers import sec_callback
    ...
    def download_file(url, read_html_table: bool = False, use_cache: bool = True):
        ...
        # pylint: disable=import-outside-toplevel
        from data_fetcher.utils.provider_helpers import run_async  # noqa
