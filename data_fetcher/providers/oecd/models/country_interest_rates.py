...
from data_fetcher.abstract_provider.standard_models.country_interest_rates import (
    CountryInterestRatesData,
    CountryInterestRatesQueryParams,
)
from data_fetcher.utils.provider_errors import EmptyDataError
from data_fetcher.providers.oecd.utils.constants import CODE_TO_COUNTRY_IR, COUNTRY_TO_CODE_IR
...
class OecdCountryInterestRatesQueryParams(CountryInterestRatesQueryParams):
    ...
    def validate_country(cls, c):
        ...
        from data_fetcher.utils.provider_helpers import check_item
...
class OecdCountryInterestRatesFetcher(
    ApiFetcher[OecdCountryInterestRatesQueryParams, list[OecdCountryInterestRatesData]]
):
    ...
    def extract_data(
        ...
        **kwargs: Any,
        ...
        from data_fetcher.providers.oecd.utils.helpers import oecd_date_to_python_date
