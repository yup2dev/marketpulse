...
from data_fetcher.providers.oecd.utils.constants import (
...
class OECDSharePriceIndexFetcher(
    ...
    def extract_data(
        ...
        **kwargs: Any,
        ...
        from data_fetcher.utils.provider_helpers import make_request  # noqa
        from data_fetcher.providers.oecd.utils.helpers import oecd_date_to_python_date  # noqa
