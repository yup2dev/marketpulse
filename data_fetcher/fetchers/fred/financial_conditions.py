"""Financial Conditions Snapshot Fetcher — NFCI + credit spreads + consumer health."""
import logging
from typing import Any, Dict, List, Optional

from data_fetcher.fetchers.base import Fetcher
from data_fetcher.fetchers.fred.series import FredSeriesFetcher
from data_fetcher.models.fred.dashboard_row import DashboardQueryParams, DashboardRowData
...
_SERIES: List[tuple] = [
    ...
    ("credit_total","TOTALSL",        13, "desc"),  # 13 obs for YoY growth
...
class FREDFinancialConditionsFetcher(Fetcher[DashboardQueryParams, DashboardRowData]):
    ...
    def transform_data(
        ...
        **kwargs: Any,
        ...
        for key, label in [("cc_delinq", "CC Delinquency"), ("loan_delinq", "Consumer Loan Delinquency"), ("mtg_delinq", "Mortgage Delinquency")]:
