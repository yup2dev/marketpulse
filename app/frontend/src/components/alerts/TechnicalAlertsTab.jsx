/**
 * 기술적 알림 탭 컴포넌트 - WidgetDashboard 기반 동적 레이아웃
 */
...
const AVAILABLE_WIDGETS = [
  { id: 'alerts-list', name: '기술적 알림 목록', description: '기술적 알림 리스트', defaultSize: { w: 12, h: 12 } },
];

// 기본 위젯 구성
const DEFAULT_WIDGETS = [
  { id: 'technical-alerts-list-1', type: 'alerts-list' },
];

// 기본 레이아웃
const DEFAULT_LAYOUT = [
  { i: 'technical-alerts-list-1', x: 0, y: 0, w: 12, h: 12, minW: 6, minH: 6 },
];
...
export default function TechnicalAlertsTab() {
  ...
  return (
    <>
      <WidgetDashboard
        dashboardId="technical-alerts-dashboard"
        title="기술적 알림"
        subtitle="기술 지표 기반 알림 관리"
