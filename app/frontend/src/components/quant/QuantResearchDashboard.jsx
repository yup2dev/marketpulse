...
export default function QuantResearchDashboard() {
  ...
  const handleRun = () => {
    ...
    // strip fields managed by ExecutionSettings to avoid double-passing
    const { stop_loss_pct: _sl, take_profit_pct: _tp, initial_capital: _ic, ...condParams } = params;
    ...
    runBacktest({
      ...
      strategy: {
        ...
        buy_conditions:  strategy.buy_conditions  ? JSON.parse(strategy.buy_conditions)  : undefined,
        sell_conditions: strategy.sell_conditions ? JSON.parse(strategy.sell_conditions) : undefined,
        ...condParams,
      },
    });
  };
    ...
    <div className="flex bg-[#0a0a0f] overflow-hidden" style={{ height: 'calc(100vh - 56px)' }}>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden bg-[#0d0d12]">
        ...
        <div className="flex-1 min-h-0 overflow-hidden">
          ...
          {/* Chart — always mounted, hidden when inactive so ChartWidget state persists */}
