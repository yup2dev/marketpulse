    ...
    categories: [
      {
        ...
        widgets: [
          ...
          { id: 'tv-mini-chart',      name: 'Mini Chart (TV)',     description: 'TradingView 종목 미니 차트',   defaultSize: { w: 4, h: 6 } },
    ...
    categories: [
      {
        ...
        widgets: [
          ...
          { id: 'bt-variables',         name: 'Variables',          description: '사용자 변수 · 지표 수식 관리',                 defaultSize: { w: 5,  h: 14 } },
          { id: 'bt-variable-explorer', name: 'Variable Explorer',  description: '변수 흐름 차트 · 통계 · 상관',                 defaultSize: { w: 7,  h: 14 } },
          { id: 'bt-events',            name: 'Events',             description: '날짜·조건식 이벤트 정의',                     defaultSize: { w: 5,  h: 14 } },
          { id: 'bt-event-study',       name: 'Event Study',        description: '이벤트 매핑 · 전후 흐름 분석',                 defaultSize: { w: 7,  h: 14 } },
          { id: 'bt-strategy',          name: 'Strategy',           description: '진입·청산 규칙 설정 · 백테스트 실행',          defaultSize: { w: 5,  h: 16 } },
          { id: 'bt-results',           name: 'Backtest Results',   description: '자산곡선 · 성과지표 · 거래내역 · 저장된 실행', defaultSize: { w: 7,  h: 16 } },
      ...
      },
      {
        ...
        label: 'Variables',
        defaultWidgets: [
          { id: 'bt-variables-1',         type: 'bt-variables',         x: 0, y: 0, w: 5, h: 14 },
          { id: 'bt-variable-explorer-1', type: 'bt-variable-explorer', x: 5, y: 0, w: 7, h: 14 },
        ],
        widgets: [
          { id: 'backtest-lab',         name: 'Backtest Lab',       description: '가격·재무·퀀트·매크로 시리즈를 한 차트에 조합', defaultSize: { w: 12, h: 14 } },
          { id: 'bt-variables',         name: 'Variables',          description: '사용자 변수 · 지표 수식 관리',                 defaultSize: { w: 5,  h: 14 } },
      ...
      },
      {
        ...
        label: 'Event Mapping',
        defaultWidgets: [
          { id: 'bt-events-1',      type: 'bt-events',      x: 0, y: 0, w: 5, h: 14 },
          { id: 'bt-event-study-1', type: 'bt-event-study', x: 5, y: 0, w: 7, h: 14 },
        ],
        widgets: [
          { id: 'backtest-lab',         name: 'Backtest Lab',       description: '가격·재무·퀀트·매크로 시리즈를 한 차트에 조합', defaultSize: { w: 12, h: 14 } },
          { id: 'bt-variables',         name: 'Variables',          description: '사용자 변수 · 지표 수식 관리',                 defaultSize: { w: 5,  h: 14 } },
      ...
      },
      {
        ...
        label: 'Backtest',
        defaultWidgets: [
          { id: 'bt-strategy-1', type: 'bt-strategy', x: 0, y: 0, w: 5, h: 16 },
          { id: 'bt-results-1',  type: 'bt-results',  x: 5, y: 0, w: 7, h: 16 },
        ],
        widgets: [
          { id: 'backtest-lab',         name: 'Backtest Lab',       description: '가격·재무·퀀트·매크로 시리즈를 한 차트에 조합', defaultSize: { w: 12, h: 14 } },
          { id: 'bt-variables',         name: 'Variables',          description: '사용자 변수 · 지표 수식 관리',                 defaultSize: { w: 5,  h: 14 } },
